    ...
    guideSections: [
      {
        ...
        items: [
          ...
          '작성된 글은 내부 기준에 따라 운영팀에 의해 편집 또는 비공개 처리될 수 있습니다.',
          '상업적 목적의 글, 명확한 설명 없이 감정만 표출한 글은 사전 안내 없이 삭제될 수 있습니다.',
        ],
      },
      {
        ...
        items: [
          ...
          '단, 직접 경험이 아닌 경우에는 출처를 함께 기재해 주세요.',
  ...
  question: {
    ...
    guideSections: [
      ...
      },
      {
        ...
        items: [
          '핵심 질문 하나에 집중하면 더 정확한 답변을 받을 수 있어요.',
          '질문을 구체적으로 작성하면 빠르게 피드백 받을 수 있어요.',
        ],
      },
      {
        title: '이미지 및 파일 업로드',
