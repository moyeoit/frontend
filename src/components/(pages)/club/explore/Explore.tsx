    ...
    <div className="bg-white-color">
      ...
      <div className="max-w-[1440px] w-full mx-auto flex justify-center">
        ...
        <div className="flex-1">
          {/* 컨테이너 */}
          {/* 필터 섹션 */}
          <div className="flex flex-row lg:items-center lg:justify-between gap-4 mt-8 pt-6 mx-5">
          ...
          <div className="pt-12">
            ...
            {!loading && !error && (
              <div className="grid grid-cols-3 flex-wrap:wrap pt-0 pb-12 gap-4 px-5">
                {/* 동아리 카드 그리드 */}
                {clubs.map((club) => (
