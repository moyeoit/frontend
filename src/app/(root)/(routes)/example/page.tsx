    ...
    <div className="p-8 space-y-12">
      ...
      <section className="space-y-4 flex justify-center items-center">
        <div className="max-w-[800px] w-full">
          <CommunityCard
            type="horizontal"
            className="gap-6 pt-8 group cursor-pointer relative"
          >
            <CommunityCard.Content className="max-w-[656px]">
              <CommunityCard.Title>프론트엔드 개발 동아리</CommunityCard.Title>
              <CommunityCard.Description>
                프론트엔드 개발을 함께 공부하고 프로젝트를 진행하는
                동아리입니다. React, Next.js, TypeScript 등을 다룹니다. React,
                Next.js, TypeScript 등을 다룹니다.
                가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하가나다라마바사아자차카타파하
              </CommunityCard.Description>
              <CommunityCard.Meta
                nickname="프론트엔드 개발 동아리"
                timeAgo="1분전"
                views={100}
                likes={100}
                comments={100}
